...
//TODO I've not written this ot use the macro component stuff, but can eventually use flixel's components when that is done
class NapeComponent extends FlxComponent {
	...
	public function new(?bodyType:BodyType, CreateRectangularBody:Bool = true, enabled:Bool = true) {
		super("nape");
	...
	override public function set_entity(entity:FlxObject):FlxObject {
		this.entity = entity;
